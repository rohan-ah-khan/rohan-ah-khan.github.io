...
<div class="posts">
  <div class="post">
    ...
    <ul class="exp-list">
      <li>
        <strong>University of Toronto</strong> — Toronto, ON<br>
        <em>M.H.Sc, Medical Genomics</em> · Sept 2024 – Apr 2026
      </li>
      <li>
        <strong>University of Calgary</strong> — Calgary, AB<br>
        <em>B.Sc, Cellular, Molecular, and Microbial Biology</em> · Sept 2019 – Jun 2022
      </li>
    </ul>
...
<style>
.exp-list { list-style: none; padding-left: 0; margin-top: 0.5rem; }
.exp-list > li { margin-bottom: 1.25rem; }
.exp-list ul { margin: 0.4rem 0 0.8rem 1.1rem; }
</style>
